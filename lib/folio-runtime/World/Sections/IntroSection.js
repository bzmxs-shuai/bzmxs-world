...
export default class IntroSection
{
    ...
    setTitles()
    {
        // Keep the original folio physical-letter intro language without
        // displaying the original author's name.
        const addLetter = (_base, _collision, _offset, _duplicated = false) =>
        {
            this.objects.add({
                base: _base.scene,
                collision: _collision.scene,
                offset: _offset,
                rotation: new THREE.Euler(0, 0, 0),
        ...
        addLetter(this.resources.items.introBBase, this.resources.items.introBCollision, new THREE.Vector3(-2.2, 0.1, 0))
        addLetter(this.resources.items.introMBase, this.resources.items.introMCollision, new THREE.Vector3(0, 0, 0))
        addLetter(this.resources.items.introSBase, this.resources.items.introSCollision, new THREE.Vector3(2.2, 0.1, 0))
        return
