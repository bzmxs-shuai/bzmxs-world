...
export default class IntroSection
{
    ...
    setTitles()
    {
        ...
        context.fillStyle = 'rgba(42, 32, 20, 0.86)'
        ...
        context.fillText('BZMXS WORLD', canvas.width / 2, 142)
        context.fillStyle = '#9fefb0'
        context.font = '700 42px Arial'
        context.fillText('EXPLORE MY NOTES, CHALLENGES AND STORIES', canvas.width / 2, 214)
        context.fillStyle = '#fff7dc'
        context.font = '700 30px Arial'
        context.fillText('WASD / ARROWS TO DRIVE · E / ENTER TO OPEN AREAS · R TO RESPAWN', canvas.width / 2, 268)
        ...
        const mesh = new THREE.Mesh(
            new THREE.PlaneGeometry(13, 3.47),
            new THREE.MeshBasicMaterial({ map: texture, transparent: true, depthWrite: false })
        )
        mesh.position.set(4, 3.2, 3)
