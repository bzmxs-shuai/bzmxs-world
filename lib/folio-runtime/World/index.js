...
import BlogAreasSection from './Sections/BlogAreasSection.js'
...
export default class World
{
    constructor(_options)
    {
        ...
        this.assetBasePath = _options.assetBasePath ?? '/folio'
    ...
    setSections()
    {
        ...
        // Blog areas
        this.sections.blogAreas = new BlogAreasSection({
            ...options,
            library: { x: 30, y: -30 },
            trainingGround: { x: -38, y: -34 },
            home: { x: 1.2, y: -55 }
        })
        this.container.add(this.sections.blogAreas.container)
    }
}
