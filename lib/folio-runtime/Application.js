...
export default class Application
{
    ...
    constructor(_options)
    {
        ...
        this.quality = _options.quality ?? 'medium'
        this.onAreaOpen = _options.onAreaOpen ?? (() => {})

        // Set up
        this.time = new Time()
        this.sizes = new Sizes()
        this.resources = new Resources(this.assetBasePath)
    ...
    setRenderer()
    {
        ...
        this.renderer.setPixelRatio(Math.min(window.devicePixelRatio, pixelRatios[this.quality] ?? 1.5))
